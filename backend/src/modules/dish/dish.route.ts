...
router.get("/global/:dishId", authorize("admin"), dishController.getGlobalDishById);
router.post("/global", authorize("admin"), uploadDishImage.single("image"), dishController.createGlobalDish);
router.patch("/global/:dishId", authorize("admin"), uploadDishImage.single("image"), dishController.updateGlobalDish);
router.delete("/global/:dishId", authorize("admin"), dishController.removeGlobalDish);
